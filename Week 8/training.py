...
def train_model(model, criterion, optimizer, train_loader, val_loader, num_epochs, save_prefix: str = None):
    ...
    def _per_gloss_metrics(y_true, y_pred):
    ...
    train_metrics_by_gloss = _per_gloss_metrics(all_train_labels, all_train_preds)
    val_metrics_by_gloss = _per_gloss_metrics(all_labels, all_preds)
    ...
    return {
        ...
        "train_metrics_by_gloss": train_metrics_by_gloss,
        "val_metrics_by_gloss": val_metrics_by_gloss,
    }
